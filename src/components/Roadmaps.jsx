...
const dataHTML = {
  ...
  items: [
    ...
    },
    {
      title: "Accesibility",
      description:
        "Accesibility asd a sd adlkasjd asldjasd lad asdlakjda sdfsds sdf sdfsfs sdf"
    }
  ]
};
  ...
  items: [
    {
      title: "Learn the basics",
      description:
        " asd a sd adlkasjd asldjasd lad asdlakjda sdfsds sdf sdfsfs sdf",
      links: [
